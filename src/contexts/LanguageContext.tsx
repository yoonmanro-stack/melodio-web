...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  ko: {
    ...
    "Audio Forge": "오디오 포지",
    "Viral & Trend Zone": "바이럴 & 트렌드 존",
    "Japan BGM Forge": "일본 BGM 포지",
    "Longform Studio": "롱폼 스튜디오",
    "VoiceDNA Studio": "보이스 DNA 스튜디오",
    "YouTube Auto-Pilot": "유튜브 오토파일럿",
    "YouTube Analytics": "유튜브 분석",
    "IP & License Vault": "IP & 라이선스 금고",
    "Distribution": "디스트리뷰션",
    "Help Center & FAQ": "고객센터 & FAQ",
    "Settings": "설정",
    "Billing & Subscription": "결제 및 구독",
    "Generate": "생성하기",
    "Save": "저장",
    "Cancel": "취소",
    "Edit": "수정",
  ...
  en: {
    ...
    "VoiceDNA Studio": "VoiceDNA Studio",
  ...
  es: {
    ...
    "VoiceDNA Studio": "Estudio de VoiceDNA",
  ...
  fr: {
    ...
    "VoiceDNA Studio": "Studio VoiceDNA",
  ...
  pt: {
    ...
    "VoiceDNA Studio": "Estúdio de VoiceDNA",
    "YouTube Auto-Pilot": "Piloto Automático de YT",
  ...
  hi: {
    ...
    "VoiceDNA Studio": "वॉइस डीएनए स्टूडियो",
