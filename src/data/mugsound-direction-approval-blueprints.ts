...
import { MUGSOUND_PLAYLIST_TARGET_SECONDS } from '../lib/mugsound/direction-batch'
...
export const MUGSOUND_DIRECTION_APPROVAL_BLUEPRINTS: DirectionApprovalBlueprint[] = [
  {
    ...
    phase: 'settle', targetEnergy: 34, targetWarmth: 62, targetBpm: 72, targetDurationSeconds: MUGSOUND_PLAYLIST_TARGET_SECONDS,
  ...
  },
  {
    ...
    phase: 'engage', targetEnergy: 43, targetWarmth: 70, targetBpm: 82, targetDurationSeconds: MUGSOUND_PLAYLIST_TARGET_SECONDS,
  ...
  },
  {
    ...
    phase: 'settle', targetEnergy: 44, targetWarmth: 68, targetBpm: 84, targetDurationSeconds: MUGSOUND_PLAYLIST_TARGET_SECONDS,
    bridgeDirection: 'ms-ep-001->ms-ep-003',
  ...
  },
  {
    ...
    phase: 'engage', targetEnergy: 53, targetWarmth: 72, targetBpm: 92, targetDurationSeconds: MUGSOUND_PLAYLIST_TARGET_SECONDS,
  ...
  },
  {
    ...
    phase: 'settle', targetEnergy: 35, targetWarmth: 58, targetBpm: 76, targetDurationSeconds: MUGSOUND_PLAYLIST_TARGET_SECONDS,
    bridgeDirection: 'ms-ep-003->ms-ep-002',
  ...
  },
  {
    ...
    phase: 'engage', targetEnergy: 46, targetWarmth: 64, targetBpm: 88, targetDurationSeconds: MUGSOUND_PLAYLIST_TARGET_SECONDS,
