      ...
      <AnimatePresence>
        {!useExternalPlayer && localPlayingTrack && (
          <motion.div
            ...
            exit={{ y: 80, opacity: 0 }}
            className="fixed bottom-0 left-0 md:left-64 right-0 z-50 bg-zinc-950/90 border-t border-white/10 backdrop-blur-md px-6 py-4 flex items-center justify-between shadow-2xl"
          >
            {/* Track Info (Left) */}
            {(() => {
