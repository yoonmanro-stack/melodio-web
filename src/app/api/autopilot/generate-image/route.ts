...
`
      ...
      finalPrompt = `${finalPrompt}. Create clean, premium, high-fidelity album artwork with luminous balanced exposure, fresh clear colors, crisp subject separation, natural highlights, and open breathable composition. Preserve the requested genre and mood while keeping shadow detail visible. No muddy color cast, no dim underexposure, no crushed blacks, no heavy vignette, and no dark wash over the image. Crucially, there must be NO text, NO typography, NO logos, NO watermark, NO letters, and NO writing whatsoever on the image.`
